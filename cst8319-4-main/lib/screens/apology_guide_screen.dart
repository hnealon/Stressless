  ...
  final List<_StepData> _steps = [
    _StepData(
      ...
      'Start by naming what happened: the event, the pattern, or what was missing. '
          'Don\'t focus on your intentions ΓÇô at least not yet. Even when you meant well, what matters most here is what your child '
...
You don't need to address everything at once. A therapeutic apology focused on one real wound is far more powerful than a sweeping attempt to try to cover everything everything (which is simply not possible).
''',
            ),
            const SizedBox(height: 24),
            ...
            _ExampleCard(
              title: 'Therapeutic Apology ΓÇô A Complete Example',
              body: '''
Here is what a finished therapeutic apology looks like, following all five (+1) steps.

Step 1 ΓÇô Acknowledge the Injury / Pattern
"I want to talk to you about something I've been thinking about ΓÇô the way that, when you were upset or going through something hard, I would sometimes jump in too quickly to reassure you or try to fix it, rather than just being with you in it. And how hard that must have been for you. Especially because you're someone who feels things deeply."

Step 2 ΓÇô Validate the Emotions
"I can imagine that when you'd come to me with something hard and I'd jump straight to 'it'll be okay' or 'here's what you should do,' you might have felt scared to keep sharing ΓÇô like maybe your feelings were too much, or like I wasn't quite able to go there with you.
...
It would have made sense if you felt embarrassed too ΓÇô like something was off about the way you were feeling, or that you were just too sensitive.
And I can imagine you might have felt some anger underneath it all ΓÇô because you deserved someone who could be with you in it."

Step 3 ΓÇô Apologize
"I want you to know that I am so sorry for the pain this caused you."

Step 4 ΓÇô Name What They Needed and What Will Change
"I can see now that what you needed was for me to slow down and just be with you ΓÇô not fix it, not make it better, just really listen and let you feel what you were feeling. Starting today, when you come to me with something hard, I'm going to work on staying there with you. I'm going to keep learning new skills, and I'm going to try to ask what you need rather than assume I know. It won't always go perfectly, but I won't stop working on this."

Step 5 ΓÇô Validate Their Reaction, Then Repeat Steps 3 & 4
...
Permission to explain: "If it would help to hear a little more about why things happened the way they did, I'm happy to share that. But not everyone wants that ΓÇô and it's completely okay if you don't. Either way, it doesn't change that it wasn't what you needed, and I see that now."
''',
            ),
