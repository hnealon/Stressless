...
const List<ScriptLibraryExample> scriptLibraryExamples = [
  ...
  ScriptLibraryExample(
    ...
    practicalSupport: [
      CategorizedOption(category: 'Space + a Plan', text: 'Let\'s take a short break and then sit down together so I can really listen, without distractions.'),
      CategorizedOption(category: 'Reconnect Plan', text: 'Let\'s find a quiet spot where just the two of us can talk it out properly.'),
      CategorizedOption(category: 'Behavioral Plan', text: 'Let\'s figure out a plan to prevent this from happening again. What if I check in with you to make sure I understand what you are trying to say?'),
    ],
  ),
  ScriptLibraryExample(
    ...
    practicalSupport: [
      ...
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Let\'s start with the part of this that feels most out of control.'),
      CategorizedOption(category: 'Soothing Activity', text: 'Let\'s take a break from the big stuff and do something fun for a bit, then come back to it.'),
    ],
  ),
  ScriptLibraryExample(
    ...
    practicalSupport: [
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Let\'s go through exactly what happened together, so I can really understand.'),
  ...
  ScriptLibraryExample(
    ...
    practicalSupport: [
      CategorizedOption(category: 'Soothing Activity', text: 'Let\'s step outside or take a few minutes away from everything to reset.'),
      ...
      CategorizedOption(category: 'Behavioral Plan', text: 'I\'m going to take one thing off your plate right now, just for today.'),
    ],
  ),
  ScriptLibraryExample(
    id: 'anger-old-hurts',
    ...
    practicalSupport: [
      ...
      CategorizedOption(category: 'Soothing Activity', text: 'Is there something that would help you feel a bit safer right now? Let’s start by making a list of your favorite activities and choose one.'),
    ],
  ),
  ScriptLibraryExample(
    ...
    practicalSupport: [
      CategorizedOption(category: 'Set a Limit', text: 'Being mean to yourself with harsh words isn\'t something we\'re going to allow - let\'s find a kinder way to talk to yourself.'),
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Let\'s think about what you\'d say to a good friend who made the same mistake, and try saying that to yourself.'),
      CategorizedOption(category: 'Behavioral Plan', text: 'Let\'s figure out one small thing you could do to help make it right.'),
    ],
  ),
  ...
  ScriptLibraryExample(
    ...
    practicalSupport: [
      ...
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Let me help you to find one small thing that might make it easier to open up - even writing it down first.'),
      CategorizedOption(category: 'Soothing Activity', text: 'Want to go outside and get some fresh air for a bit?'),
    ],
  ),
  ScriptLibraryExample(
    id: 'shame-messed-up',
    ...
    practicalSupport: [
      ...
      CategorizedOption(category: 'Soothing Activity', text: 'Let’s work on a puzzle or play cards to give you a break from the feeling.'),
  ...
  ScriptLibraryExample(
    ...
    practicalSupport: [
      CategorizedOption(category: 'Space + a Plan', text: 'Let\'s talk through it gently, after a break. I’ll come check on you in a few minutes.'),
      CategorizedOption(category: 'Behavioral Plan', text: 'Once you\'re ready, we can figure out together what comes next.'),
      CategorizedOption(category: 'Soothing Activity', text: 'How about a few minutes with a fidget toy or something in your hands?'),
    ],
  ),
  ScriptLibraryExample(
    id: 'shame-unworthy',
  ...
  ScriptLibraryExample(
    ...
    practicalSupport: [
      ...
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Let\'s think about this the way you would if it happened to a friend.'),
      CategorizedOption(category: 'Behavioral Plan', text: 'Let me help you pick something small you could do today that might feel like a step in the right direction.'),
    ],
  ),
  ScriptLibraryExample(
    ...
    practicalSupport: [
      ...
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Would it help if I asked you a few easy questions, rather than you having to start from scratch?'),
    ],
  ),
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Positive Regard', text: 'You are learning, growing, and trying - and that\'s what matters.'),
    ...
    practicalSupport: [
      ...
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'I think we might need to make a list of your strengths together, so that you can remember how great you are.'),
    ],
  ),
  ScriptLibraryExample(
    ...
    validationOpener: "I can understand why embarrassment is showing up right now...",
    becauseStatements: [
    ...
    practicalSupport: [
      CategorizedOption(category: 'Set a Limit', text: 'It\'s okay to feel that upset - hitting or throwing things isn\'t okay, and we\'ll keep practicing safer ways to let big feelings out.'),
      CategorizedOption(category: 'Behavioral Plan', text: 'Let’s go over what I could have done differently so that we can have a better chance at resolving things the next time.'),
      CategorizedOption(category: 'Soothing Activity', text: 'Let me get you a glass of water or something comforting while we settle back down together.'),
    ],
  ),
  ScriptLibraryExample(
    ...
    practicalSupport: [
      ...
      CategorizedOption(category: 'Reconnect Plan', text: 'Let’s focus on a place or a group where you feel most like yourself.'),
      CategorizedOption(category: 'Soothing Activity', text: 'Let’s go for a drive to get a break from the big feelings.'),
    ],
  ),
  ScriptLibraryExample(
    id: 'shame-from-past',
    ...
    validationOpener: "I can understand why this brings up bad feelings for you...",
    becauseStatements: [
    ...
    practicalSupport: [
      ...
      CategorizedOption(category: 'Soothing Activity', text: 'Let\'s find something fun to watch — sometimes a little distraction helps.'),
  ...
  ScriptLibraryExample(
    ...
    practicalSupport: [
      ...
      CategorizedOption(category: 'Soothing Activity', text: 'Let\'s talk about what happened, or do something fun to take your mind off it for a bit — whichever you\'d rather.'),
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Is there one person you\'re most worried about? Let\'s think through how to handle the next time you see them together.'),
    ],
  ),
  ScriptLibraryExample(
    ...
    practicalSupport: [
      ...
      CategorizedOption(category: 'Behavioral Plan', text: 'Let’s figure out an apology or an action that could help start to repair things.'),
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Let\'s sit down together tonight and go through exactly what kind of support would help most — whether that\'s help fixing it, someone to talk to, or just some space to think.'),
    ],
  ),
  ScriptLibraryExample(
    id: 'shame-too-much',
    ...
    practicalSupport: [
      ...
      CategorizedOption(category: 'Behavioral Plan', text: 'I\'m going to check in with you a little more this week, just so you know I\'m here.'),
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Let\'s talk through what\'s been making you feel this way, so we can work on it together.'),
    ],
  ),
  ScriptLibraryExample(
    id: 'shame-left-out',
    ...
    practicalSupport: [
      ...
      CategorizedOption(category: 'Reconnect Plan', text: 'Let’s plan some time with another friend or person in your life you feel safe with.'),
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Let\'s sit down together tonight and go through what happened, step by step, so I can help you to figure out what to do next.'),
    ],
  ),
  ScriptLibraryExample(
    ...
    validationOpener: "I can imagine why you'd feel embarrassed of feeling this way...",
    becauseStatements: [
    ...
    practicalSupport: [
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Let\'s talk through what\'s been going on so I can understand what kind of support would help most.'),
      CategorizedOption(category: 'Behavioral Plan', text: 'I\'m going to check in with you a little more often, especially in the moments that feel hardest.'),
      CategorizedOption(category: 'Behavioral Plan', text: 'I\'m going to work on making it easier and safer for you to come to me when you\'re struggling.'),
    ],
  ),
  ...
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Togetherness', text: 'You don\'t have to face this by yourself — I\'m right here and I\'m not going anywhere.'),
      CategorizedOption(category: 'Positive Regard', text: 'I can see how tired you are, and you don\'t have to keep carrying this alone.'),
      CategorizedOption(category: 'Belief in Them', text: 'I don\'t know exactly when or how things will shift, but I believe they can — and I\'ll hold that hope for you until you can hold it yourself.'),
      CategorizedOption(category: 'Positive Regard', text: 'You are trying so hard, and that means something, even when it doesn\'t feel like it.'),
      CategorizedOption(category: 'Togetherness', text: 'I am in this with you, all the way.'),
    ],
    practicalSupport: [
  ...
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Sharing a Perspective', text: 'Your efforts matter — to me, and far more than you can see right now.'),
      CategorizedOption(category: 'Belief in Them', text: 'I notice how hard you try, even when it\'s hard, and I am proud of you.'),
      CategorizedOption(category: 'Positive Regard', text: 'What you do and who you are matters deeply, even in moments when it doesn\'t feel that way.'),
      CategorizedOption(category: 'Belief in Them', text: 'I believe in you, even when you don\'t believe in yourself.'),
      CategorizedOption(category: 'Sharing a Perspective', text: 'You are making a difference, even if you can\'t see it yet.'),
    ],
    practicalSupport: [
  ...
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Comfort / Love', text: 'You are not a burden to me. You are someone I love and want to support.'),
      CategorizedOption(category: 'Togetherness', text: 'Being here for you is something I want to do — not something I do despite the hard parts.'),
      CategorizedOption(category: 'Togetherness', text: 'I would rather know you\'re struggling than have you carry this alone.'),
      CategorizedOption(category: 'Belief in Them', text: 'You matter so much to me — please don\'t forget that.'),
  ...
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Sharing a Perspective', text: 'I am trying, with everything I have, to see you as clearly as I can.'),
      CategorizedOption(category: 'Positive Regard', text: 'Your experience matters deeply to me.'),
      CategorizedOption(category: 'Reassurance', text: 'I might not always get it perfectly right, but I am never going to stop trying to understand.'),
      CategorizedOption(category: 'Reassurance', text: 'You don\'t have to explain it perfectly — I\'ll keep trying to get it.'),
  ...
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Belief in Them', text: 'I see how hard you\'ve been trying and I\'m proud of you for that.'),
      CategorizedOption(category: 'Sharing a Perspective', text: 'Your worth is not measured by your grades or how school is going.'),
      CategorizedOption(category: 'Belief in Them', text: 'I believe in your ability to figure this out — and I\'m going to help.'),
      CategorizedOption(category: 'Sharing a Perspective', text: 'You\'re not struggling because you\'re not smart. You\'re struggling, and those are very different things.'),
      CategorizedOption(category: 'Togetherness', text: 'We\'re going to figure this out together — you don\'t have to take this on alone.'),
    ],
    practicalSupport: [
  ...
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Reassurance', text: 'I\'m not going to force anything — this is your call and I respect that.'),
      CategorizedOption(category: 'Positive Regard', text: 'I can see how much this has been weighing on you.'),
      CategorizedOption(category: 'Togetherness', text: 'Whatever you decide, I\'m on your side.'),
      CategorizedOption(category: 'Reassurance', text: 'It\'s okay to rest. It\'s okay to take a break. It\'s okay to feel conflicted.'),
  ...
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Togetherness', text: 'I\'m right here. You don\'t have to carry this feeling alone.'),
      CategorizedOption(category: 'Positive Regard', text: 'What you\'re feeling makes complete sense to me.'),
      CategorizedOption(category: 'Reassurance', text: 'I\'m so sorry this happened.'),
      CategorizedOption(category: 'Comfort / Love', text: 'Your heart matters to me, and I want to take care of it.'),
  ...
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Togetherness', text: 'Your sadness is welcome with me. I\'m here for all of it.'),
      CategorizedOption(category: 'Reassurance', text: 'Grief takes as long as it takes, and I\'ll be here the whole way.'),
      CategorizedOption(category: 'Reassurance', text: 'You don\'t have to pretend you\'re okay when you\'re not.'),
      CategorizedOption(category: 'Comfort / Love', text: 'I love you and I\'m not going to rush you.'),
  ...
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Togetherness', text: 'I see you. You matter — deeply.'),
      CategorizedOption(category: 'Positive Regard', text: 'What you\'re feeling makes complete sense.'),
      CategorizedOption(category: 'Togetherness', text: 'You belong here, with me, fully and completely.'),
      CategorizedOption(category: 'Positive Regard', text: 'I\'m sorry this is happening, and I want you to know you are so valued.'),
      CategorizedOption(category: 'Reassurance', text: 'You don\'t have to feel invisible — not with me.'),
    ],
    practicalSupport: [
  ...
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Togetherness', text: 'I\'m right here with you. You don\'t need to have an explanation to be held.'),
      CategorizedOption(category: 'Togetherness', text: 'You don\'t have to figure it out. I just want to be with you in it.'),
      CategorizedOption(category: 'Reassurance', text: 'Your feelings are always welcome here, even the unexplained ones.'),
      CategorizedOption(category: 'Reassurance', text: 'It\'s okay not to have words for this.'),
      CategorizedOption(category: 'Comfort / Love', text: 'I love you, with or without a reason.'),
    ],
    practicalSupport: [
  ...
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Reassurance', text: 'You\'re not alone right now — I\'m with you.'),
      CategorizedOption(category: 'Togetherness', text: 'I care about you and I want to be one of your people.'),
      CategorizedOption(category: 'Belief in Them', text: 'You matter to me more than you know.'),
      CategorizedOption(category: 'Sharing a Perspective', text: 'Loneliness doesn\'t mean you\'re unlovable — it means you\'re human.'),
  ...
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Comfort / Love', text: 'Let yourself soften here — I\'ve got you.'),
      CategorizedOption(category: 'Reassurance', text: 'You don\'t have to be strong right now. Not with me.'),
      CategorizedOption(category: 'Positive Regard', text: 'You deserve real rest — not just sleep, but emotional rest too.'),
      CategorizedOption(category: 'Togetherness', text: 'I see how tired you are and I want to help carry some of this.'),
      CategorizedOption(category: 'Reassurance', text: 'I\'m here, and I\'m not going to ask anything of you right now.'),
    ],
    practicalSupport: [
  ...
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Togetherness', text: 'I\'m here — you don\'t have to move through this shift alone.'),
      CategorizedOption(category: 'Reassurance', text: 'Take all the time you need. There\'s no timeline on grief.'),
      CategorizedOption(category: 'Togetherness', text: 'I\'ll walk through this with you, whatever the pace.'),
      CategorizedOption(category: 'Positive Regard', text: 'It makes complete sense that you feel the way you do.'),
      CategorizedOption(category: 'Comfort / Love', text: 'I love you, and I\'m not going anywhere.'),
    ],
    practicalSupport: [
  ...
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Sharing a Perspective', text: 'The fact that you feel sad tells me how much this mattered — and that\'s beautiful.'),
      CategorizedOption(category: 'Sharing a Perspective', text: 'Good things can and do happen again, even though it doesn\'t feel that way right now.'),
      CategorizedOption(category: 'Reassurance', text: 'It\'s okay to miss something that was wonderful.'),
      CategorizedOption(category: 'Togetherness', text: 'I\'m glad you had that experience, and I\'m here with you in the missing of it.'),
  ...
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Sharing a Perspective', text: 'The people who matter to us leave their mark on us — and that means something.'),
      CategorizedOption(category: 'Sharing a Perspective', text: 'Missing someone is a sign of love, and that\'s not a bad thing.'),
      CategorizedOption(category: 'Reassurance', text: 'I\'m so sorry you\'re carrying this feeling right now.'),
      CategorizedOption(category: 'Togetherness', text: 'I\'m here. I\'m not the same as who you\'re missing, but I love you and I\'m here.'),
  ...
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Reassurance', text: 'This is a real loss and it\'s completely okay to grieve it.'),
      CategorizedOption(category: 'Positive Regard', text: 'Your love for them was real and it was beautiful.'),
      CategorizedOption(category: 'Reassurance', text: 'It\'s okay to cry, and it\'s okay to feel this for as long as you need to.'),
      CategorizedOption(category: 'Comfort / Love', text: 'I\'m so sorry. I know how much they meant to you.'),
  ...
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Reassurance', text: 'This is a real loss and it\'s okay to grieve it.'),
      CategorizedOption(category: 'Positive Regard', text: 'What you\'re feeling makes complete sense.'),
      CategorizedOption(category: 'Positive Regard', text: 'You were a good friend, and this doesn\'t change that.'),
      CategorizedOption(category: 'Sharing a Perspective', text: 'The right friendships will feel safe and lasting — and you deserve those.'),
  ...
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Togetherness', text: 'I\'m right here — we can face this feeling together.'),
      CategorizedOption(category: 'Reassurance', text: 'You are safe right now, and I\'m not going anywhere.'),
      CategorizedOption(category: 'Togetherness', text: 'I\'m not going to tell you to calm down — let\'s just settle together, slowly.'),
      CategorizedOption(category: 'Sharing a Perspective', text: 'Your body is trying to help you. Let\'s help it relax a little.'),
      CategorizedOption(category: 'Reassurance', text: 'I\'ve got you.'),
    ],
    practicalSupport: [
      CategorizedOption(category: 'Soothing Activity', text: 'Let\'s take a slow breath together and look around to see what\'s actually safe right now.'),
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Put your feet flat on the floor and tell me five things you can see — let\'s do that together.'),
      CategorizedOption(category: 'Space + a Plan', text: 'Can we move to a quieter spot and let your nervous system come down a little?'),
    ],
  ),
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Togetherness', text: 'You don\'t have to figure this out alone — I\'ll walk with you through it.'),
      CategorizedOption(category: 'Positive Regard', text: 'It makes complete sense that you\'re worried. This matters to you and that\'s not a bad thing.'),
      CategorizedOption(category: 'Belief in Them', text: 'I believe in you, even when you don\'t believe in yourself right now.'),
      CategorizedOption(category: 'Reassurance', text: 'Whatever happens, I\'ll be right here.'),
      CategorizedOption(category: 'Belief in Them', text: 'We\'ve gotten through hard things before, and we\'ll get through this one too.'),
    ],
    practicalSupport: [
      CategorizedOption(category: 'Behavioral Plan', text: 'Let\'s break this into one tiny step and see what would help that first step feel more manageable.'),
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Can we talk through what you\'re most worried about so we can see if there\'s anything we can prepare for?'),
      CategorizedOption(category: 'Behavioral Plan', text: 'Is there something we can do today that would help you feel even a little more ready?'),
    ],
  ),
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Sharing a Perspective', text: 'The care that lives inside your anxiety is something I really respect.'),
      CategorizedOption(category: 'Positive Regard', text: 'Caring this much is a quality I love about you.'),
      CategorizedOption(category: 'Sharing a Perspective', text: 'Your anxiety is not a flaw — it\'s a sign of how much heart you have.'),
      CategorizedOption(category: 'Togetherness', text: 'We\'re going to channel that care in a direction that helps you feel better.'),
      CategorizedOption(category: 'Togetherness', text: 'I\'m with you on this.'),
    ],
    practicalSupport: [
      CategorizedOption(category: 'Behavioral Plan', text: 'Let\'s put that care to use by figuring out one small thing you can actually do right now.'),
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Is there any preparation we can do together that might make you feel a bit more in control?'),
      CategorizedOption(category: 'Soothing Activity', text: 'Can we also build in some time to do something that\'s purely for fun, with no pressure?'),
    ],
  ),
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Positive Regard', text: 'I believe you. What you\'re feeling is real, even if we can\'t totally explain it.'),
      CategorizedOption(category: 'Positive Regard', text: 'You\'re not being dramatic or overreacting — your body is doing something very normal.'),
      CategorizedOption(category: 'Togetherness', text: 'Let\'s meet this feeling gently, together.'),
      CategorizedOption(category: 'Sharing a Perspective', text: 'There is nothing wrong with you. You\'re just human.'),
      CategorizedOption(category: 'Reassurance', text: 'I\'m right here with you.'),
    ],
    practicalSupport: [
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Let\'s gently separate "what my body feels" from "what\'s actually happening right now" — together.'),
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Can we name three things that are real and true about this moment?'),
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'What helps your body settle when it\'s done this before?'),
    ],
  ),
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Togetherness', text: 'I\'m with you — you don\'t have to manage all of those pieces alone.'),
      CategorizedOption(category: 'Togetherness', text: 'We can narrow this down together.'),
      CategorizedOption(category: 'Sharing a Perspective', text: 'You\'re not supposed to be able to hold all of that at once — that\'s not a failing.'),
      CategorizedOption(category: 'Togetherness', text: 'Let\'s take a breath and simplify, together.'),
      CategorizedOption(category: 'Belief in Them', text: 'I believe we can figure this out.'),
    ],
    practicalSupport: [
      CategorizedOption(category: 'Behavioral Plan', text: 'Let\'s choose the one or two things that matter most right now and start just there.'),
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Can we write out all the pieces and then decide together what actually needs attention?'),
      CategorizedOption(category: 'Behavioral Plan', text: 'Is there something we can take off the list entirely, at least for today?'),
    ],
  ),
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Sharing a Perspective', text: 'Your anxiety shows your values — that matters.'),
      CategorizedOption(category: 'Sharing a Perspective', text: 'There is almost never a perfect choice, just the best one you can make right now.'),
      CategorizedOption(category: 'Reassurance', text: 'Whatever happens, we\'ll be okay and we\'ll figure it out together.'),
      CategorizedOption(category: 'Belief in Them', text: 'I trust your judgment more than you trust it right now.'),
      CategorizedOption(category: 'Belief in Them', text: 'I\'m proud of how seriously you take things that matter.'),
    ],
    practicalSupport: [
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Let\'s explore the options together and see which one feels most right — not perfect, just right.'),
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Can we make a list of the pros and cons and talk through them?'),
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Is there someone we trust that we could get a second opinion from?'),
    ],
  ),
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Togetherness', text: 'I\'m right here — you don\'t have to "calm down"; let\'s settle together.'),
      CategorizedOption(category: 'Sharing a Perspective', text: 'What your body is doing makes sense, even if it\'s uncomfortable.'),
      CategorizedOption(category: 'Togetherness', text: 'We\'re going to get through this feeling together.'),
      CategorizedOption(category: 'Reassurance', text: 'You are safe. I\'m right here.'),
      CategorizedOption(category: 'Soothing Activity', text: 'Let\'s just breathe for a minute and let your body know you\'re okay.'),
    ],
    practicalSupport: [
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Try putting your hand where it feels strongest and breathing slowly into that spot — let\'s do it together.'),
      CategorizedOption(category: 'Space + a Plan', text: 'Can we move somewhere that feels a little more comfortable and quieter?'),
      CategorizedOption(category: 'Soothing Activity', text: 'Let\'s shake out our hands and arms, or take a short walk — movement can really help.'),
    ],
  ),
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Sharing a Perspective', text: 'Let\'s thank that part of you for trying to look out for you — and then gently guide it.'),
      CategorizedOption(category: 'Togetherness', text: 'I\'m here, and we\'re going to deal with what\'s in front of us together.'),
      CategorizedOption(category: 'Belief in Them', text: 'You\'ve handled hard things before. I\'ve seen it.'),
      CategorizedOption(category: 'Togetherness', text: 'Whatever happens, we\'ll face it together.'),
      CategorizedOption(category: 'Reassurance', text: 'You are not alone in this.'),
    ],
    practicalSupport: [
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Let\'s name the worry once — just say it out loud — and then name three things that are actually true and safe right now.'),
      CategorizedOption(category: 'Behavioral Plan', text: 'Is there something useful we can do to prepare, so your brain feels like it\'s done something?'),
      CategorizedOption(category: 'Soothing Activity', text: 'Can we do something that brings you into the present moment — something concrete and sensory?'),
    ],
  ),
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Sharing a Perspective', text: 'Your body\'s memory is welcome here — we\'ll move through this together.'),
      CategorizedOption(category: 'Reassurance', text: 'What happened before is not what\'s happening now, and you\'re safe with me.'),
      CategorizedOption(category: 'Space + a Plan', text: 'I\'m not going to rush you. We\'ll take this at whatever pace works for you.'),
      CategorizedOption(category: 'Reassurance', text: 'I\'m here, right now, and I\'m not going anywhere.'),
      CategorizedOption(category: 'Togetherness', text: 'You don\'t have to go through this alone.'),
    ],
    practicalSupport: [
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Let\'s anchor in this present moment together: where are we, who\'s here, and what\'s different now?'),
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Is there something that usually helps when past stuff comes up like this?'),
      CategorizedOption(category: 'Soothing Activity', text: 'Let\'s do something grounding together — something that helps you feel safe and in the present.'),
    ],
  ),
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Belief in Them', text: 'I see how hard you\'re working, and I\'m proud of you.'),
      CategorizedOption(category: 'Togetherness', text: 'You are not alone in finding school overwhelming — a lot of kids do.'),
      CategorizedOption(category: 'Sharing a Perspective', text: 'Your worth is not measured by how school is going.'),
      CategorizedOption(category: 'Togetherness', text: 'I\'m going to help you figure this out.'),
      CategorizedOption(category: 'Reassurance', text: 'You can always come to me when school feels like too much.'),
    ],
    practicalSupport: [
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Let\'s break down what feels most overwhelming and see if we can make any of it smaller.'),
      CategorizedOption(category: 'Reconnect Plan', text: 'Can we reach out to your teacher or school together to get some extra support?'),
      CategorizedOption(category: 'Behavioral Plan', text: 'Is there something we can do tonight that would help tomorrow feel a little more manageable?'),
    ],
  ),
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Togetherness', text: 'Social stuff is genuinely hard, and you\'re not alone in finding it that way.'),
      CategorizedOption(category: 'Positive Regard', text: 'What you\'re feeling makes complete sense.'),
      CategorizedOption(category: 'Belief in Them', text: 'I believe in you and I think you handle these situations better than you give yourself credit for.'),
      CategorizedOption(category: 'Togetherness', text: 'I\'m going to be here to support you before, during (if I can), and after.'),
      CategorizedOption(category: 'Belief in Them', text: 'You\'ve done hard social things before and you\'ve gotten through them.'),
    ],
    practicalSupport: [
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Let\'s talk through what you\'re most worried about and see if we can prepare for it a little.'),
      CategorizedOption(category: 'Behavioral Plan', text: 'Is there one person at this thing that you feel safe with? Let\'s plan to stay near them.'),
      CategorizedOption(category: 'Behavioral Plan', text: 'Can we come up with an exit plan — something that makes it feel more okay to go, knowing you can leave if you need to?'),
    ],
  ),
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Positive Regard', text: 'I take your concerns seriously and I want to help.'),
      CategorizedOption(category: 'Togetherness', text: 'We\'re going to look into this together so you don\'t have to carry the worry alone.'),
      CategorizedOption(category: 'Togetherness', text: 'Whatever is going on, you\'re not dealing with it by yourself.'),
      CategorizedOption(category: 'Positive Regard', text: 'I\'m glad you told me rather than holding it in.'),
      CategorizedOption(category: 'Comfort / Love', text: 'I love you and your health matters to me very much.'),
    ],
    practicalSupport: [
      CategorizedOption(category: 'Behavioral Plan', text: 'Let\'s make an appointment with the doctor so we can get some real answers and put your mind at rest.'),
      CategorizedOption(category: 'Share a Skill / Brainstorm', text: 'Can you show me or describe what you\'re noticing so I can help figure out what to do?'),
      CategorizedOption(category: 'Soothing Activity', text: 'While we wait for an appointment, is there something that might help you feel a bit less worried today?'),
    ],
  ),
  ScriptLibraryExample(
    ...
    emotionalSupport: [
      CategorizedOption(category: 'Reassurance', text: 'You are safe, even when it doesn\'t feel that way.'),
      CategorizedOption(category: 'Reassurance', text: 'I\'m just in the next room and you can always come to me.'),
      CategorizedOption(category: 'Togetherness', text: 'Night fears are so common — you are not the only kid who feels this way.'),
      CategorizedOption(category: 'Comfort / Love', text: 'I love you and I want you to feel safe when you go to sleep.'),
      CategorizedOption(category: 'Togetherness', text: 'We\'re going to figure this out together so nights feel less scary.'),
    ],
    practicalSupport: [
      CategorizedOption(category: 'Behavioral Plan', text: 'Let\'s figure out something that helps your room feel safer at night — a light, a comfort object, a check-in routine.'),
      CategorizedOption(category: 'Behavioral Plan', text: 'Can we make a plan together for what to do when the scary feeling comes up at night?'),
      CategorizedOption(category: 'Soothing Activity', text: 'Is there something we can do before bed — like talking, reading together, or a breathing exercise — that helps your body and mind wind down?'),
    ],
  ),
];
